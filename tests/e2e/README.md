...
This is a Go project that allows for manual/interactive testing (with msgpack decoding -> JSON), e2e testing, and load testing. See below on how to run with different modes.
